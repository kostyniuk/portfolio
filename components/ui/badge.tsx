...
type BadgeAsLinkProps = {
  href: string;
  children: ReactNode;
  variant?: VariantProps<typeof badgeVariants>["variant"];
};

function BadgeAsLink({ href, variant = "default", children }: BadgeAsLinkProps) {
  return <Badge variant={variant} render={<a href={href}>{children}</a>} />;
}

export { Badge, BadgeAsLink, badgeVariants };
