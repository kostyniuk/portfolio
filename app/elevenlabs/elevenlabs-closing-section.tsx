...
export function ElevenLabsClosingSection({ portfolioHref = "/" }: { portfolioHref?: string }) {
  return (
    <section
      className="elevenlabs-hints-trigger relative flex h-dvh snap-start items-center justify-center overflow-hidden bg-[#fdfcfc] px-6 text-black"
      aria-label="Application closing"
    >
      <div className="elevenlabs-orb elevenlabs-orb-orange absolute -right-[18vw] top-[-22vw] size-[52vw] min-h-96 min-w-96 opacity-60" />
      <div className="elevenlabs-orb elevenlabs-orb-blue absolute -bottom-[28vw] -left-[20vw] size-[58vw] min-h-96 min-w-96 opacity-50" />

      <div className="relative z-10 flex w-full max-w-[54rem] flex-col items-center text-center">
        <ElevenLabsMark className="mb-8 size-14 sm:mb-10 sm:size-20" />
        <p className="w-full text-balance text-[clamp(2rem,4.75vw,4.5rem)] leading-[0.98] font-medium tracking-[-0.055em]">
          Let&apos;s build what the world listens to next.
        </p>
        <GlassBadge
          glassVariant="liquid"
