          ...
          <ItemContent>
            <ItemHeader className="items-start">
              <div className="space-y-1">
                ...
                <ItemDescription>shadcn UI primitives with glassy status markers for product surfaces.</ItemDescription>
              </div>
            </ItemHeader>
            <div className="flex flex-wrap items-center gap-2 pt-2">
              <LiquidBadge variant="secondary">shadcn/ui</LiquidBadge>
              <LiquidBadge className="bg-emerald-500 text-white hover:bg-emerald-500">Vercel Ready</LiquidBadge>
              <LiquidBadge className="bg-red-500 text-white hover:bg-red-500">Preview Failed</LiquidBadge>
            </div>
          </ItemContent>
        </Item>
      </CardContent>
